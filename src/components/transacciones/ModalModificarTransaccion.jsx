...
export default function App() {
  ...
  const modificarTransacciones = async() => {
    try {
  ...
  return (
    <>
      <Button onPress={onOpen} color="warning">Modificar Transacciones</Button>
      <Modal 
        isOpen={isOpen} 
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">Modificar Transaccion</ModalHeader>
              <ModalBody>
              ...
              <ModalFooter>
                ...
                <Button color="warning" onPressStart={modificarTransacciones} onPressEnd={onClose}>
                  Modificar
                </Button>
              </ModalFooter>
            </>
