...
export default function App() {
  ...
  return (
    <>
      <Button onPress={onOpen} color="danger">Eliminar Viaje</Button>
      <Modal 
        isOpen={isOpen} 
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">Eliminar Viaje</ModalHeader>
              <ModalBody>

              <div className="flex w-full max-w-xs flex-col gap-2">
              <Select
                label="Viaje a Eliminar"
                variant="bordered"
                selectedKeys={[value]}
                className="max-w-xs"
              ...
              <Input
                ...
                <Input
                  ...
                  readOnly
                />
                <Checkbox isSelected={estado} onValueChange={setEstado} isDisabled>
                    Completado
                </Checkbox>
              ...
              <ModalFooter>
                ...
                <Button color="danger" onPressStart={modificarViaje} onPressEnd={onClose}>
                  Eliminar
                </Button>
              </ModalFooter>
            </>
